    ...
    return (
        <div className="font-sans text-black-text flex flex-col h-screen">
            <Head>
                ...
                {/* Open Graph */}
                <meta property="og:url" content="https://iamng.wtf/widgets/prop-house-community" />
                <meta
                    property="og:image"
                    content="https://iamng.wtf/img/widgets/prop-house-community/main.png"
                />
            ...
            <main className="max-w-screen-md mx-auto my-20 text-center text-lg px-8">
                ...
                <div className="font-black text-5xl text-red">Prop House Community Widget</div>
                <div className="mt-4 text-2xl">Keep an eye on prop house communities</div>
                <div className="mt-16">
                    <Image
                ...
                <div className="mt-2">Now open{' '}
                    ...
                    website and open community you would like to track.</div>
                ...
                <div className="mt-2">Paste copied community address as widget parameter.</div>
                <div className="mt-4">
                    <Image
                        className="rounded-xl"
                ...
                <div className="flex flex-row gap-1 items-baseline justify-center">
                    <a
                        ...
                        onClick={() => {
                            navigator.clipboard.writeText('https://iamng.wtf/widgets/prop-house-community')
                        }}
                    >
