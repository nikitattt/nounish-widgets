...
const NounsLockScreen: NextPage = () => {
    const data = {
        ...
        description: 'Keep an eye on nouns auction and number of active props from the lock screen',
        widgetIconImage: '',
    ...
    const meta = {
        ...
        twitterShare: 'http://twitter.com/share?text=Want to peep an eye on nouns auction and number of active props from the lock screen?%0a%0aGet yourself the widget!&url=https://iamng.wtf/widgets/nouns-lock-screen'
    }
    ...
    return (
        <div className="font-sans text-black-text flex flex-col h-screen">
            ...
            <main className="max-w-screen-md mx-auto my-20 text-center text-lg px-8">
                ...
                <div className="mt-2">
                    Next, add a 2 sections Scriptable widget to the Lock Screen. You need to have iOS 16+ to support lock screen widgets.
                    <br />
                    <br />
